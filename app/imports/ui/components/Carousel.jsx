...
const DynamicCarousel = () => {
  ...
  const ResourceItems = [
    ...
    { title: 'College of Natural Sciences', link: 'https://natsci.manoa.hawaii.edu/sasc/study-away/' },
    { title: 'Shidler College of Business', link: 'https://shidler.hawaii.edu/international-exchange' },
    { title: 'College of Engineering', link: 'https://coe.hawaii.edu/international/study-away/' },
    { title: 'John A. Burns School of Medicine', link: 'https://jabsom.hawaii.edu/education/global-health/index.html' },
    { title: 'College of Social Sciences', link: 'https://socialsciences.manoa.hawaii.edu/study-at-css/experiential-learning/study-abroad/' },
